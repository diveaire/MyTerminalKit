# Generated by Powerlevel10k configuration wizard on 2024-02-01 at 09:11 CET.
...
() {
  ...
  # USER
  POWERLEVEL9K_USER_FOREGROUND='202'  # Couleur du texte
  # DATE
  ...
  #POWERLEVEL9K_BATTERY_DISCONNECTED_STAGES=$POWERLEVEL9K_BATTERY_STAGES
  #POWERLEVEL9K_BATTERY_CHARGED_STAGES=$POWERLEVEL9K_BATTERY_STAGES
